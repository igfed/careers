...
//?q=complete+financial+planning
    ...
    function outputMoreList(data,slideList){
        ...
        for (i = 0; i < slideList.length; i++){
            ...
            htmlCode = htmlCode + '<div class="slide-image"><a href="'+data.slides[slideList[i]].link+'"><img src="'+data.slides[slideList[i]].img+'" alt=""></a></div>';
            htmlCode = htmlCode + '<div class="slide-content"><h2><a onclick="igTrack.inline(this)" data-tracking-category="Click" data-tracking-label="MORE-Slider-Story" href="'+data.slides[slideList[i]].link+'">'+data.slides[slideList[i]].title+'</a></h2><div class="excerpt"><p>'+data.slides[slideList[i]].excerpt+'</p></div><a href="'+data.slides[slideList[i]].link+'" class="cta underline-link">'+data.slides[slideList[i]].cta+'</a></div></div>';
        }
  ...
  function moreHome(){
    ...
    prevArrow: '<span type="button" class="carousel-prev"><img src="/external/app/tribal/images/Arrow-MainArticle-Carousel-Green-L.svg"></span>',
    nextArrow: '<span type="button" class="carousel-next"><img src="/external/app/tribal/images/Arrow-MainArticle-Carousel-Green-R.svg"></span>',
    speed: 1200,
    dots: true,
    slidesToShow: 2,
    slidesToScroll: 2,
